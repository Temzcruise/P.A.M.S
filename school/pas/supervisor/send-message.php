...
if(isset($_POST['submit']))
{
	...
	$supervisorName = mysqli_real_escape_string($con,$_POST['supervisor']);
	$supEmail = mysqli_real_escape_string($con,$_POST['email']) ;
	$message = $_POST['message'];
	$query = "INSERT into usermessage(course,supname,sup_message,email) 
	values ('$course','$supervisorName','$message', '$supEmail')";
...
<html lang="en">
	<head>
		<title>Supervisor  | Send Message</title>
		<meta charset="utf-8" />
	...
	<div id="app">		
		...
		<section id="page-title">
			<div class="row">
				<div class="col-sm-8">
					<h1 class="mainTitle">Supervisor | Send Message</h1>
				</div>
				<ol class="breadcrumb">
					<li>
		...
		<div class="form-group">
			...
			<select name="supervisor" class="form-control" required="required">
				<option selected value="Dr Odumuyiwa">Dr Odumuyiwa</option>
			</select>
		</div>	
		<div class="form-group">
			<label for="email">
