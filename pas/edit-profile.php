...
<div class="main-content" >
	...
	<textarea name="matric_no" class="form-control"><?php echo htmlentities($data['matric_no']);?></textarea>
	</div>
	<div class="form-group">
		<label for="email">
			User Email
...
if(isset($_POST['submit']))
{
	...
	$sql=mysqli_query($con,"Update users set fullName='$fname',matric_no='$matric_no', profile_pic='$profile_picture', where email='".$_SESSION['email']."'");
	if($sql)
	{
